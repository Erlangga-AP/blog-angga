...
//         <div className="relative h-[300px] lg:h-[450px] lg:w-[700px] max-w-4xl grid justify-items-center">
//           <Image
//             src={post.blogImage}
//             alt="image"
//             fill
...
//                 return (
//                   <h2 className="font-semibold mt-9 text-2xl sm:text-xl md:text-2xl">
//                     {children}
//                   </h2>
//                 );
//               },
...
//                 return (
//                   <p className="mt-4 text-base sm:text-lg md:text-xl font-normal">
//                     {children}
//                   </p>
//                 );
//               },
